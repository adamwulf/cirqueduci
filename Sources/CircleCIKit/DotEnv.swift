...
//  cirqueduci
//
//  Mirrors hunch's DotEnv: walks UP the directory hierarchy looking for a
//  `.env` file and returns the first value found for a key.
//
...
public enum DotEnv {
    ...
    ///
    /// - Parameters:
    ///   - key: The environment variable name to look for (e.g. `"CIRCLECI_API_KEY"`)
